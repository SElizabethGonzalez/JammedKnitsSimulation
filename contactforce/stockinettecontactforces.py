...
# FOR A GIVEN SIMUALTION THAT IS ALREADY RUN, THIS GENERATES ADDITIONAL INFORMATION ABOUT THE CONTACT FORCES
# and re-writes the ContactMapOut file
# use the ResultsOut.dat to make the init file so that you can avoid the minimization step
...
files_open()
contact_energy(x0, print_to_file=True)
files_close()
...
# 	elif step_num >= 2 and strain <= 4 and stress <= 0.4:
# 		current_dimension += step_size
# 	else:
# 		sweep_flag = False
# 		break
